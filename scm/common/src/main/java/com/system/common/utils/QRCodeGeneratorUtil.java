...
public class QRCodeGeneratorUtil {
     ...
     * @author fxbin
     */
    public static BufferedImage insertWords(BufferedImage image, String words, String time, String userName) {
        ...
        if (StringUtils.isNotEmpty(words)) {
            ...
            int rightFirstWordsWidth = WIDTH - g2d.getFontMetrics().stringWidth(userName);
            // 画文字
            g2d.drawString(words, wordStartX, wordStartY);
            g2d.drawString(time, timeWidth, wordStartY + 18);
            g2d.drawString(userName, rightFirstWordsWidth, wordStartY + 18);
            g2d.dispose();
            outImage.flush();
            return outImage;
        }
